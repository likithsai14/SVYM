...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    if (!qtn || !answer || typeof qtn !== 'string' || typeof answer !== 'string' || qtn.trim() === '' || answer.trim() === '') {
      return {
        statusCode: 400,
        body: JSON.stringify({ message: 'Both qtn and answer are required and must be non-empty strings' })
      };
    }
